...
module.exports.run = (client, message, args) => {
    ...
    helpembed.addField("?docs <başlık>","Belirlenen dosyanın anlatımına götürür. Örnek olarak class başlığının alt başlığı olan Attachments i görmek için ?docs Attachments")
