    ...
    message.channel.fetchMessage(args[0]).then(msg => {
        ...
        switch(msg.embeds[0].footer) {
            case "partner":
                ...
                message.guild.channels.get("530795148242583552").send(msg.embeds[0].description);
                text = "Partnerlik Başvurunuz onaylanmıştır! Lütfen aşağıda belirttiğim metni kopyalayıp kendi sunucunuzda ilgili yere yapıştırınız ve eğer bu mesaj atıldıktan sonra 1 saat içinde kendi sunucunuzu <#530795148242583552> kanalında göremiyorsanız Furkan veya C4Navarı etiketleyiniz." + "```\n**Türk Geliştiriciler Platformu(TGP)**\nKodlamayı seviyorsanız kesinlikle bize katılmalısınız! TGP, Türk yazılımcıları ve geliştiricleri bir araya getirip aralarında bir bağ oluşturmaya dayalı bir sunucudur.\nSunucuda Neler Var ?\n• Kendine özel rol ve puan sistemi.\n• Neredeyse her programlama dili için özel kanallar.\n• Aktif Kitle\n• Discord Botunuzu geliştirmeye yardımcı olacak kişiler\n• Özel emojiler\n• Çekilişler\n\nVe daha fazlası!\n**Hemen Katılmak İçin Tıkla:** https://discord.gg/tRZuCYj```"
            break;
            case "geliştirici":
